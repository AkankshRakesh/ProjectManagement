            ...
            <div className="mb-3 flex w-full">
                ...
                <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
                    ...
                    <div className='flex items-center gap-1'>
                        ...
                        <button className='flex h-6 w-5 items-center justify-center rounded bg-gray-200 dark:bg-dark-tertiary dark:text-white' onClick={() => setIsModalNewTaskOpen(true)}>
                            <Plus size={16} />
                        </button>    
                    </div>
                </div>
...
const Task = ({task}: TaskProps) => {
    ...
    const numberOfComponents = (task.comments && task.comments.length) || 0;
